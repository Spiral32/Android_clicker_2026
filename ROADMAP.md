...
Реализовать планировщик задач для автоматизации сценариев.

### В рамках Stage 7 нужно:
- разработать систему планирования выполнения сценариев по расписанию
- интегрировать планировщик с системными событиями (например, время суток, события устройства)
- добавить UI для настройки расписаний и автоматического запуска
- обеспечить безопасность и контроль над автоматическими запусками
- реализовать логику приоритетов и очередей задач

### Stage 7 считается завершённым, когда:
- планировщик позволяет запускать сценарии по расписанию без ручного вмешательства
- интеграция с системными событиями работает стабильно
- UI предоставляет полный контроль над планированием
